 ...
 */
{
  ...
  GOMA_WH(GOMA_ERROR, "CAP_ENDFORCE_SCALAR tangent [%g, %g] sign %g", fv->stangent[0][0], fv->stangent[0][1], sign);

  GOMA_WH_ALLPROC(1, "Sign on Surface Tangent Scalar is be incorrect in certain cases");
