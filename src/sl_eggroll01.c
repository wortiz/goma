...
void gevp_solver_rc(int nj,
                    ...
                    dbl *v1,
                    dbl *v2) {
  static int i, j, k, ip, ir, mmm, n_shift, nev_want_to_get, transformation;
  static dbl xm, w1, w2, *r_shift, *i_shift, *rev, *iev, *res, *q1, *q2, *q3, *q4, *qres;
...
l02:
  ...
  l20:
     ...
     */
    gevp_arnoldi_rc(nj, mm, transformation, maxit, filter, nev_want_to_get, n_shift, &r_shift[0],
                    &i_shift[0], tol, nev_found, &rev[0], &iev[0], &res[0], evect, gamma, rcflag,
     ...
     */
      ...
      *ev_n = (*nev_found);
       ...
       */
      gevp_order(nj, *ev_n, &ev_r[0], &ev_i[0], &ev_e[0], &ev_x[0], evect, gamma);
