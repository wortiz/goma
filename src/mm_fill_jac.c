...
void jacobianVD_realloc(JACOBIAN_VAR_DESC_STRUCT **jacVD_hdl, int num_lvdesc, int num_lvdof)
 ...
 *********************************************************************/
{
  ...
  if (jacVD->NUM_LVDESC_MALLOC < num_lvdesc) {
    realloc_int_1(&(jacVD->Lvdesc_Index), num_lvdesc, jacVD->NUM_LVDESC_MALLOC);
    realloc_dbl_1(&(jacVD->JacCol), num_lvdesc, jacVD->NUM_LVDESC_MALLOC);
    jacVD->NUM_LVDESC_MALLOC = num_lvdesc;
  }
  if (jacVD->NUM_LVDOF_MALLOC < num_lvdof) {
    realloc_int_1(&(jacVD->Lvdof_var_type), num_lvdof, jacVD->NUM_LVDOF_MALLOC);
    realloc_int_1(&(jacVD->Lvdof_lvdof), num_lvdof, jacVD->NUM_LVDOF_MALLOC);
    realloc_dbl_1(&(jacVD->Jac_lvdof), num_lvdof, jacVD->NUM_LVDOF_MALLOC);
...
void jacobianVD_free(JACOBIAN_VAR_DESC_STRUCT *jacVD)
...
void jacobianVD_destroy(JACOBIAN_VAR_DESC_STRUCT **jacVD_hdl)
...
void jacobianVD_zero(JACOBIAN_VAR_DESC_STRUCT *jacVD)
 ...
 *********************************************************************/
{
  ...
  (void)memset((void *)jacVD->JacCol, 0, sizeof(double) * jacVD->Num_lvdesc);
  (void)memset((void *)jacVD->Jac_lvdof, 0, sizeof(double) * jacVD->Num_lvdof);
}
/************************************************************************/
/************************************************************************/
/************************************************************************/

void jacobianVD_addNewEntry(JACOBIAN_VAR_DESC_STRUCT *jacVD, int index_lvdesc, double entry)
...
void jacobianLVDOF_addNewEntry(JACOBIAN_VAR_DESC_STRUCT *jacVD,
                               int var_type,
                               int lvdof,
                               double entry)
...
void jacobianVD_addEntry(JACOBIAN_VAR_DESC_STRUCT *jacVD, int index_lvdesc, double entry)
