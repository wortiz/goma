...
{ /*start*/
  ...
  if ((ConstitutiveEquation == NEWTONIAN) || (ConstitutiveEquation == TURBULENT_SA) || (ConstitutiveEquation == TURBULENT_SA_DYNAMIC) || (ConstitutiveEquation == TURBULENT_K_OMEGA_SST)) {
    model_read = look_for_mat_proptable(
