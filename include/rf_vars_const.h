...
extern int variable_description_alloc(
    VARIABLE_DESCRIPTION_STRUCT *, const int, const int, const int, const int);
...
extern VARIABLE_DESCRIPTION_STRUCT *Variable_Description_Match(VARIABLE_DESCRIPTION_STRUCT *);
...
extern void assign_species_name(const int n, MATRL_PROP_STRUCT *mp_local, char *, char *, int);
extern void assign_var_name(const int, const int, MATRL_PROP_STRUCT *, char *, char *, int);
#endif
