...
EXTERN int foam_pmdi10_viscosity(int species, /* species number for cure equation */
...
EXTERN int bond_viscosity_sh(int bond_species, /* integer associated with conc eqn for bond */
...
EXTERN int ls_modulate_viscosity(double *,                      /* Primary phase viscosity value */
