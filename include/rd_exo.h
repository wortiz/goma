...
EXTERN int rd_exo(Exo_DB *, const char *, const int, const int);

int brk_rd_exo(Exo_DB *x, /* def'd in exo_struct.h */
               char *fn,
               int verbosity,
               int task);

EXTERN int free_exo(Exo_DB *); /* pointer to EXODUS II FE db structure */
