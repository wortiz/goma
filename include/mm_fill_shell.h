...
EXTERN void apply_surface_viscosity(double cfunc[MDE][DIM],
...
EXTERN int assemble_porous_shell_gasn(double, double, double xi[DIM], const Exo_DB *exo);

EXTERN int assemble_porous_shell_open(double, /* theta or tt */
                                      double, /* dt */
                                      double xi[DIM],
                                      const Exo_DB *exo);

EXTERN int assemble_porous_shell_open_2(double, /* theta or tt */
                                        double, /* dt */
                                        double xi[DIM],
                                        const Exo_DB *exo);
