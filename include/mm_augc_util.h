...
EXTERN void update_parameterAC(int,       /* NUMBER OF AC'S */
...
EXTERN int std_aug_cond(
    int, int, double[], double **, double **, double **, double *, int, Comm_Ex *, MF_Args *);

EXTERN void overlap_aug_cond(
    int[], double[], double[], double *, double **, double **, double **, Comm_Ex *, MF_Args *);

EXTERN int std_lgr_cond(int,
                        int,
                        double[],
                        double **,
                        double **,
