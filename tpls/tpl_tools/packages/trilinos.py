...
class Package(packages.CMakePackage):
    ...
    def configure_options(self, builder):
        ...
        builder.add_option("-DTrilinos_ENABLE_Ifpack:BOOL=OFF")
        ...
        builder.add_option("-DTrilinos_ENABLE_Epetra:BOOL=OFF")
        builder.add_option("-DTrilinos_ENABLE_AztecOO:BOOL=OFF")
        builder.add_option("-DTrilinos_ENABLE_Amesos:BOOL=OFF")
